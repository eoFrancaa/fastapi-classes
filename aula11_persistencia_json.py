...
# A partir daqui a fonte de dados é produtos.json (60 produtos, ids 1–60).
# Não há paginação ainda: o GET devolve a coleção como array simples.
...
def criar_produto(produto: ProdutoInput):
    ...
    # Gera o próximo id com base no maior id existente (funciona com lista vazia)
...
# Rodar servidor:
# uvicorn aula11_persistencia_json:app --reload

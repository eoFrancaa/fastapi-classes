...
# Aula 12 — Paginação sobre a coleção persistida (60 produtos em produtos.json).
# O GET devolve um objeto paginado: { page, page_size, total_pages, results }.
...
def listar_produtos(
    ...
    # Paginação (aula 12): page base 1, page_size padrão 10, máximo 100
    pagina = 1
    tamanho_pagina = 10
    ...
    # 1. obter coleção; 2. aplicar filtro; 3. aplicar busca; 4. aplicar ordenação
    resultado = produtos
    ...
    # 5. calcular total; 6. calcular total_pages; 7. calcular índices; 8. slice
    total = len(resultado)
...
# Rodar servidor:
# uvicorn aula12_paginacao:app --reload
